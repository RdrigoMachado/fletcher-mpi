...
//MPI ESCRITA
  if(rank == 1)
  {
    MPI_recebimento(sx, sy, sz, fNameSec, st, dtOutput, dt, dx, dy, dz, 1);
  }
  if(rank == 2){
    MPI_recebimento(sx, sy, sz, fNameSec, st, dtOutput, dt, dx, dy, dz, 0);
  }
